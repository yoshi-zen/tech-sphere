          ...
          <div className={styles.siteHead}>
            ...
            <section>
              ...
              <p className={styles.aboutUsText}>
                ものづくりが好きな大学生たちが集まって、自らが重ね上げた成果物を発表できる場がほしいと
                感じ、本サイトを立ち上げるに至りました。なお、本サイト開発者がReactを学習し、それを実践
                する場としての役割も兼ねております。各所、至らぬ点が多くあると存じますが、温かい目で見守っていただけると
                幸いです。大学での授業のあいまに、逐次サイトの改良を重ねていければと考えておりますから、
                ご意見ご感想等はお気軽にどうぞ！
              </p>
            </section>
          </div>
